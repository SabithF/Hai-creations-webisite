...
const BannerNine: React.FC = () => {
  const [viewMore, setViewMore] = useState(false);
  const galleryRef = useRef<HTMLDivElement | null>(null);

  const images = useMemo(
    () => Array.from({ length: 6 }, (_, i) => `/assets/img/cartoon/${i + 1}.png`),
    []
  );
  ...
  return (
    <section className="relative">
      {/* Banner */}
      <img src="/assets/banner/cartoon-banner.jpg" alt="Banner 9" className="w-full h-auto" />

...
const BannerFive: React.FC = () => {
  ...
  const images = useMemo(
    () => Array.from({ length: 22 }, (_, i) => `/assets/img/corporate/${i + 1}.jpg`),
    []
  );
  ...
  return (
    <section className="relative">
      {/* Banner */}
      <img src="/assets/banner/Banner-5.jpg" alt="Banner 5" className="w-full h-auto" />
        ...
        >
          {featured.map((src, index) => (
            <motion.div
              ...
              className="
                overflow-hidden rounded-3xl bg-slate-100
